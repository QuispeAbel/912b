...
import com.example.a912b.databinding.FragmentCamTraseraBinding

class CamTraseraFragment : Fragment() {
    private var _binding : FragmentCamTraseraBinding? = null
    private val binding get() = _binding!!

    private lateinit var textureView: TextureView
    private lateinit var btnRecordTrasera: Button
    ...
    override fun onCreateView(
        ...
        _binding = FragmentCamTraseraBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        textureView = binding.textureViewTrasera
        btnRecordTrasera = binding.btnGrabarTrasera
        btnStopRecording = binding.btnDetenerTrasera

        cameraManager = requireActivity().getSystemService(Context.CAMERA_SERVICE) as CameraManager

        btnRecordTrasera.setOnClickListener {
            startRecording("0") // ID de la cámara trasera
        }
    ...
    private fun toggleButtons(isRecording: Boolean) {
        btnRecordTrasera.isEnabled = !isRecording
